...
class FichaTreino : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = findViewById(R.id.recyclerViewTreino)
        recyclerView.layoutManager = LinearLayoutManager(this)

        val treinos = listOf(
            GrupoMuscular("Peito + Bíceps", listOf(
            ...
            GrupoMuscular("Costas + Tríceps", listOf(
            ...
            GrupoMuscular("Quadríceps", listOf(
            ...
            GrupoMuscular("Posterior de Perna", listOf(
        ...
        val adapter = FichaTreinoAdapter(treinos)
